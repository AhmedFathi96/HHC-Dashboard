            ...
            >
              ...
              <div className="modal-body">
                <div className="py-3 text-center">
                  ...
                  <p>
                    Do you want to remove {obj.english_header} from Features ? to confirm please press delete otherwise close
                  </p>
                </div>
              </div>
        ...
        >
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">
              {obj?.arabic_header === ''? 'Create Feature': 'Edit Feature'}
            </h5>
            <button
              aria-label="Close"
              className="close"
          ...
          <Form role="form"onSubmit={(event) => handleSubmit(event)}>
            <FormGroup>
              <label className="form-control-label" htmlFor="example-text-input">Feature Order</label>
                    ...
                    <Card>
                      <CardHeader className="border-0">
                        <div style={{display:'flex' , alignItems:'center', justifyContent:'space-between'}}>
                          <h3 className="mb-0">Features table</h3>
                          ...
                          <Button onClick={()=>{
                            ...
                            setObj(
                              ...
                              <span className="btn-inner--text">Create new feature</span>
